function(add_vsop87_cc target verid fileext)
	...
	add_custom_command(
	    OUTPUT ${outfile}
		COMMAND "${Python_EXECUTABLE}" "${CMAKE_CURRENT_SOURCE_DIR}/vsop87_conv.py" "${CMAKE_SOURCE_DIR}/share/Catalogs/SolarSystem/vsop87/VSOP87${verid}.${fileext}" "vsop87${verid}.${fileext}.h"
		MAIN_DEPENDENCY "${CMAKE_SOURCE_DIR}/share/Catalogs/SolarSystem/vsop87/VSOP87${verid}.${fileext}"
...
function(add_vsop87_test_cc target fileext)
	...
	add_custom_command(
		OUTPUT ${outfile}
		COMMAND "${Python_EXECUTABLE}" "${CMAKE_CURRENT_SOURCE_DIR}/tests_conv.py" "${CMAKE_SOURCE_DIR}/share/Catalogs/SolarSystem/vsop87/VSOP87.${fileext}" "vsop87.${fileext}.h"
		MAIN_DEPENDENCY "${CMAKE_SOURCE_DIR}/share/Catalogs/SolarSystem/vsop87/VSOP87.${fileext}" 
