...
public:
	...
	CEquGridDataset() : m_longitudeStep(15), m_latitudeStep(15), m_style(tStyle::LINES), m_dirty(true) {}
	...
	void paint(QPainter& painter, const CQuaterniond& q,
...
private:
	...
	std::optional<QPainterPath> toPath(const std::vector<CVector3d>& pts, const CQuaterniond& q, const CProjection& p, const CTransformd& m,
		const QRectF& paint_rect) const;
};