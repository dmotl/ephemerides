function(add_elp82_cc target verid fileext)
	...
	add_custom_command(
	    OUTPUT ${outfile}
		COMMAND "${Python_EXECUTABLE}" "${CMAKE_CURRENT_SOURCE_DIR}/elp82_conv.py" "${CMAKE_SOURCE_DIR}/share/elp82/ELP${verid}.${fileext}" "elp82_${verid}.h"
		MAIN_DEPENDENCY "${CMAKE_SOURCE_DIR}/share/elp82/ELP${verid}.${fileext}"
